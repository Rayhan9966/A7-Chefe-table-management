  ...
  return (
    <div>
      ...
      <div className="hero min-h-screen bg-no-repeat mt-5 rounded-2xl" style={{ backgroundImage: 'url(https://i.postimg.cc/hGjw9jhs/Rectangle-1.png)' }}>
        ...
        <div className="hero-content text-center">
          <div className="max-w-md text-color-white ">
            <h1 className="mb-5 text-5xl font-bold text-center ban mt-3">Discover an exceptional cooking class tailored for you!e</h1>
      ...
      <div>
        ...
        <p className='text-2xl'>This dish embodies the essence of User's culinary expertise, offering a harmonious blend of freshness, richness, and sophistication.</p>
      </div>
